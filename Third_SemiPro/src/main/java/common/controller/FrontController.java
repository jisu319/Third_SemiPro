...
@WebServlet(
		...
		urlPatterns = { "*.go" }, 
		initParams = { 
				@WebInitParam(name = "propertyConfig", value = "C:/git/Third_SemiPro/Third_SemiPro/src/main/webapp/WEB-INF/command.properties", description = "*.go에 대한 클래스의 매핑파일")
		})
	...
	*/
		 ...
		 */
			...
			*/
			...
			System.out.println(">>> C:/NCS/workspace(jsp)/MyMVC/src/main/webapp/WEB-INF/Command.propertise 파일이 없습니다. <<<");
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
